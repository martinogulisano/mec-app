# Interactive Simulators for Dynamical Systems

A collection of browser-based interactive simulators for dynamical systems, built with plain HTML and JavaScript — no installation required.

You can run them directly online at:
**[martinogulisano.github.io/mec-app](https://martinogulisano.github.io/mec-app/)**
...
Just open any `.html` file in a browser, or visit the link above.

> **Note:** These simulators are designed for **laptop/desktop use**.
...
Created by Marco Gabiccini and [Martino Gulisano](https://github.com/martinogulisano) — with a little help from Claude.
